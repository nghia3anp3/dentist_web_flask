...
- **sp_TinhTien**:
    - Tham số truyền vào: *@SDT VARCHAR(20), @MaHoSo int*
    - Kết quả trả về:
        - 1: tính tiền thành công
        - 0: không thành công (@SDT không tồn tại, Khách hàng @SDT không có hồ sơ @MaHoSo, Hồ sơ đã được tính tiền)
    - Chức năng: Thực hiện tính tiền cho @MaHoSo của Khách hàng @SDT
